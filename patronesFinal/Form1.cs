...
namespace patronesFinal
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            InitializeComponent();
            SqlConnection conecta = new SqlConnection();
            conecta.ConnectionString = "Data Source=(LocalDB)//MSSQLLocalDB;AttachDbFilename=|DataDirectory|dbPatrones.mdf;Integrated Security=True";
        }
        ...
        private void bt_login_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand com = new SqlCommand("select loginuser, pass from login where loginuser='" + txb_user.Text + "' and pass='" + txb_pass.Text + "'", conecta);
